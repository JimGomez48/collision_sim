...
# color
RED = (gl.GLfloat * 4)(*[1.0, 0.02, 0.02, 1.0])
DARK_RED = (gl.GLfloat * 4)(*[0.6, 0.02, 0.02, 1.0])
GREEN = (gl.GLfloat * 4)(*[0.2, 1.0, 0.2, 1.0])
DARK_GREEN = (gl.GLfloat * 4)(*[0.05, 0.5, 0.2, 1.0])
SKY_BLUE = (gl.GLfloat * 4)(*[0.5, 0.7, 0.9, 1.0])
BLUE = (gl.GLfloat * 4)(*[0.2, 0.2, 1.0, 1.0])
DARK_BLUE = (gl.GLfloat * 4)(*[0.02, 0.02, 0.5, 1.0])
YELLOW = (gl.GLfloat * 4)(*[1.0, 1.0, 0.05, 1.0])
PURPLE = (gl.GLfloat * 4)(*[0.4, 0.05, 0.8, 1.0])
ORANGE = (gl.GLfloat * 4)(*[1.0, 0.5, 0.04, 1.0])
MAGENTA = (gl.GLfloat * 4)(*[1.0, 0.02, 1.0, 1.0])
CYAN = (gl.GLfloat * 4)(*[0.2, 1.0, 1.0, 1.0])
